...
class Client extends Authenticatable
{
    ...
    protected $fillable = [
        'name', 'email', 'address', 'phone', 'payment_due_date', 'vat_slab', 'gbs_information', 'is_vip', 'vip_discount', 'email_verified_at', 'status', 'parent_client_id', 'user_id', 'type','password'
    ];
